...
export function renderSection(s: Section, base: string = ''): string {
  switch(s.type) {
    ...
    case 'cta': return `<div class=”article-cta”><p>${s.content}</p><a href=”${base}/submit/” class=”btn btn-primary”>${base ? '提交您的视频' : 'Submit Your Video'} <span class=”chev”>›</span></a></div>`;
